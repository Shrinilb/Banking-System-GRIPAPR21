...
.contactus:before{
    ...
    bottom: 0;
    right:0;
    background:linear-gradient(20deg,#800033 55%, #fff 0%);
    z-index: -1;
}
.formbutton button{
...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center"><h2>VIA BANK</h2></a>
      ...
      <span class="navbar-toggler-icon" style="background:white;"></span>
       ...
       <div class="collapse navbar-collapse text-center" id="collapsenavbar">
          <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                  <a href="#contact" class="nav-link text-white">REACH US</a></li>    
               </ul>
        </div>
     </div>
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            <h1 class="main_text">VIA BANK</h1>
            <p class="big-text">A SMOOTH BANKING EXPERIENCE</p>
          </div>

          <div class="col-sm-6">
            
            <img src="12.png" class="img-fluid" width="420" height="205" style="margin:50px 130px">
  ...
  <section class="contactus" id="contact" >
        <div class="container headings text-center">
            <h1 class="center" style="font-weight: bold;text-align: center;">REACH US</h1>
            <p>ENTER YOUR QUERIES HERE. WE WILL BE ANSWERING YOU SHORTLY</p>
                    ...
                    <form action="/action_page.php">
                        ...
                        <form action="/action_page.php">
                            <div class="form-group">
                              ...
                              <input type="email" class="form-control" placeholder="ENTER YOUR EMAIL-ID" id="email" required autocomplete="off">
                            </div>
                            <form action="/action_page.php">
                                <div class="form-group">
